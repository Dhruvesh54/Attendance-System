...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="row g-3" action="{{ route('admin.bulkdata_attendance') }}" method="POST"
        ...
        <section class="section">
            <div class="row" style="position: relative">
                <div class="excel-container">
                    ...
                    <a href="{{route('admin.export_attendance')}}" id="excelButton" class="btn btn-excel" style="background: #21A366;  margin: 10px">
                        ...
                        <div class="card-body table-responsive">
                            <table id="user-table" class="table">
                                <thead>
                                    ...
                                    <th>
                                        <input type="search" id="search" name="search" placeholder="Search In Time">
                                    </th>
                                    <th>
                                        <input type="search" id="search" name="search" placeholder="Search Out Time">
                                    </th>
